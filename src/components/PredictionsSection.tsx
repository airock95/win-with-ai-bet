      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto mb-12 animate-fade-in">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12">
            {[
              { icon: Database, title: "Data Crunching", desc: "Analisi di migliaia di dati storici" },
              { icon: Search, title: "Pattern Detection", desc: "Riconoscimento di modelli vincenti" },
              { icon: Award, title: "Highest Confidence", desc: "Solo pronostici ad alta confidenza" },
              { icon: History, title: "Storico Pubblico", desc: "Trasparenza totale sui risultati" }
            ].map((item, i) => (
          ...
          <div className="my-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Vantaggi chiave</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
              {[
                "Decisioni basate sui dati",
                "Trasparenza totale",
                "Risparmio di tempo", 
                "Indipendenza dai bookmaker"
              ].map((benefit, i) => (
                <div key={i} className="flex items-center p-3">
                  <div className="bg-aiwinbet-green/10 rounded-full p-1 mr-3">
                    <Check className="h-5 w-5 text-aiwinbet-green" />
                  </div>
          ...
          <div className="my-16">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { num: "①", title: "Raccogliamo statistiche", desc: "Dati storici e performance delle squadre" },
                  { num: "②", title: "Il modello calcola le probabilità", desc: "L'AI elabora i dati e identifica le quote di valore" },
                  { num: "③", title: "Ti inviamo il pronostico", desc: "Ricevi il pick con maggior confidenza" }
                ].map((step, i) => (
